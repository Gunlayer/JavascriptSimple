...
function handleClick(clickedButtonEvent) {
    ...
    let textBtn = clickedButtonEvent.target.innerText;   
...
function showMoreText(card) {
    ...
    let descriptionText = "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Accusamus illo minima adipisci distinctio suscipit, neque sunt.";
    // 6.2 внутри .product есть .productName, после него вставляем div.desc и текстом из переменной из п. 6.1
    card.productName.insertAdjacentHTML ("afterend", `<div class="desc">${descriptionText}</div>`)
